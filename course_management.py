import sqlite3
from db_operations import delete_course, delete_course_teacher_mapping, add_course, add_branch_teacher_course_mapping, DB_PATH

# helper to open the database file
